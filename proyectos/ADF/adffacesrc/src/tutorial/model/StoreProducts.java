...
public class StoreProducts {
    ...
    public StoreProducts() {
        ...
        Product a = new Product("iPod Nano","Electronics",150,new Date(),"/images/nano.gif",8,"Instead of the hard disk which is used in the iPod Classic, the Nano uses flash memory. This means there are no moving parts related to memory, making the iPod Nano resistant to memory failure due to sudden movement.");
        products.add(a);
        a = new Product("iPod Classic","Electronics",250,new Date(),"/images/classic.gif",7,"The iPod Classic is a portable media player marketed by Apple Inc. To date, there have been six generations of the iPod Classic, as well as a spin-off (the iPod Photo) that was later re-integrated into the main Classic line. All generations use a 1.8-inch hard drive for storage.");
        products.add(a);
